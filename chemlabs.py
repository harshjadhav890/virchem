...
st.image("Chemlabs_transparent.png", width=200)
st.title("Welcome to Chemlabs")
...
help_bar.markdown("""**Chemlabs** is a data app that allows you to perform experiments involving graphical calculations
